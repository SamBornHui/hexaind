...
class TestHealthInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HealthInfo:
        ...
        if include_optional:
            return HealthInfo(
                metadatabase = airflow_client.models.metadatabase_status.MetadatabaseStatus(
                    status = 'healthy', ),
                scheduler = airflow_client.models.scheduler_status.SchedulerStatus(
                    status = 'healthy', 
                    latest_scheduler_heartbeat = '', ),
                triggerer = airflow_client.models.triggerer_status.TriggererStatus(
                    status = 'healthy', 
                    latest_triggerer_heartbeat = '', ),
                dag_processor = airflow_client.models.dag_processor_status.DagProcessorStatus(
                    status = 'healthy', 
