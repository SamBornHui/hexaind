    ...
    def make_instance(self, include_optional) -> RoleCollection:
        ...
        if include_optional:
            return RoleCollection(
                total_entries = 56,
                roles = [
                    airflow_client.models.role.Role(
                        name = '0', 
                        actions = [
                            airflow_client.models.action_resource.ActionResource(
                                action = airflow_client.models.action.Action(
                                    name = '', ), 
                                resource = airflow_client.models.resource.Resource(
                                    name = '', ), )
                            ], )
                    ]
            )
