...
class XCom(BaseModel):
    ...
    value: Optional[Any] = Field(default=None, description="The value(s),")
    __properties: ClassVar[List[str]] = ["key", "timestamp", "execution_date", "map_index", "task_id", "dag_id", "value"]
