...
class GetGroupShared200Response(BaseModel):
    """
    GetGroupShared200Response
    """ # noqa: E501
    items: Optional[List[Share]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Share.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
