...
class TestQueuedEventCollection(unittest.TestCase):
    """QueuedEventCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueuedEventCollection:
        """Test QueuedEventCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueuedEventCollection`
        """
        model = QueuedEventCollection()
        if include_optional:
            return QueuedEventCollection(
                total_entries = 56,
                datasets = [
                    airflow_client.models.queued_event.QueuedEvent(
                        uri = '', 
                        dag_id = '', 
    ...
    def testQueuedEventCollection(self):
        """Test QueuedEventCollection"""
