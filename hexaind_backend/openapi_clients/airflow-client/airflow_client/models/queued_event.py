...
class QueuedEvent(BaseModel):
    ...
    QueuedEvent
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="The datata uri.")
    dag_id: Optional[StrictStr] = Field(default=None, description="The DAG ID.")
    created_at: Optional[datetime] = Field(default=None, description="The creation time of QueuedEvent")
    __properties: ClassVar[List[str]] = ["uri", "dag_id", "created_at"]
