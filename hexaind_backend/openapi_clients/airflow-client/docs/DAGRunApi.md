...
with airflow_client.ApiClient(configuration) as api_client:
    ...
    clear_dag_run = airflow_client.ClearDagRun() # ClearDagRun | 
...
with airflow_client.ApiClient(configuration) as api_client:
    ...
    dag_id = 'dag_id_example' # str | The DAG ID.
    dag_run_id = 'dag_run_id_example' # str | The DAG run ID.
    set_dag_run_note = airflow_client.SetDagRunNote() # SetDagRunNote | Parameters of set DagRun note.
...
with airflow_client.ApiClient(configuration) as api_client:
    ...
    dag_id = 'dag_id_example' # str | The DAG ID.
    dag_run_id = 'dag_run_id_example' # str | The DAG run ID.
    update_dag_run_state = airflow_client.UpdateDagRunState() # UpdateDagRunState | 
