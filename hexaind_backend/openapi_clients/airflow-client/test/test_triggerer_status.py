...
class TestTriggererStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TriggererStatus:
        """Test TriggererStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggererStatus`
        """
        model = TriggererStatus()
        if include_optional:
            return TriggererStatus(
                status = 'healthy',
