...
class DagStatsStateCollectionItem(BaseModel):
    """
    DagStatsState entry collection item.
    """ # noqa: E501
    state: Optional[StrictStr] = Field(default=None, description="The DAG state.")
    count: Optional[StrictInt] = Field(default=None, description="The DAG state count.")
