...
class EventLog(BaseModel):
    ...
    run_id: Optional[StrictStr] = Field(default=None, description="The DAG Run ID")
    map_index: Optional[StrictInt] = Field(default=None, description="The Map Index")
    try_number: Optional[StrictInt] = Field(default=None, description="The Try Number")
    ...
    __properties: ClassVar[List[str]] = ["event_log_id", "when", "dag_id", "task_id", "run_id", "map_index", "try_number", "event", "execution_date", "owner", "extra"]
