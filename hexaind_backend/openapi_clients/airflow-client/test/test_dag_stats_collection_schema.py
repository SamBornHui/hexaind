...
class TestDagStatsCollectionSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DagStatsCollectionSchema:
        """Test DagStatsCollectionSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DagStatsCollectionSchema`
        """
        model = DagStatsCollectionSchema()
        if include_optional:
            return DagStatsCollectionSchema(
                total_entries = 56,
                dags = [
                    airflow_client.models.dag_stats_collection_item.DagStatsCollectionItem(
                        dag_id = '', 
                        stats = [
                            airflow_client.models.dag_stats_state_collection_item.DagStatsStateCollectionItem(
                                state = '', 
                                count = 56, )
                            ], )
                    ]
