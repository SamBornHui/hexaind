...
class PostUserActivityRequest(BaseModel):
    """
    ...
    servers: Optional[PostUserActivityRequestServers] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servers": PostUserActivityRequestServers.from_dict(obj["servers"]) if obj.get("servers") is not None else None
        })
        return _obj
