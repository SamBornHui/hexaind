...
@Component({
  selector: 'app-parquet-widget-config',
  templateUrl: './parquet-widget-config.component.html',
  styleUrls: ['./parquet-widget-config.component.less']
})
export class ParquetWidgetConfigComponent {
  @ViewChild(SettingsComponent) settingsComponent!: SettingsComponent;
  @ViewChild('fileInput')
  fileInput!: ElementRef;
  selectedOption: string | undefined = undefined;
  connectors: Connector[] = [];
  parquetDescription: string = '';
  parquetName: string = '';
  files: any;
  ...
  initializeInformation() {
    this.data = {
      ...
      description: 'retrieves Parquet data for further processing upstream',
  ...
  onSave() {
    ...
    if (this.configCache && this.configCache.sink) {
      this.configCache.sink.dataset_name = 'parquet_dataset';
      this.configCache.sink.dataset_description = 'parquet_dataset_description';
