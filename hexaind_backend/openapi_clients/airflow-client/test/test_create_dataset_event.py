...
class TestCreateDatasetEvent(unittest.TestCase):
    """CreateDatasetEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDatasetEvent:
        """Test CreateDatasetEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDatasetEvent`
        """
        model = CreateDatasetEvent()
        if include_optional:
