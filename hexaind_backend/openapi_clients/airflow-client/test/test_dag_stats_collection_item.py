...
class TestDagStatsCollectionItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DagStatsCollectionItem:
        """Test DagStatsCollectionItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DagStatsCollectionItem`
        """
        model = DagStatsCollectionItem()
        if include_optional:
            return DagStatsCollectionItem(
                dag_id = '',
                stats = [
