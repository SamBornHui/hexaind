...
class TestTaskInstanceDependencyCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TaskInstanceDependencyCollection:
        """Test TaskInstanceDependencyCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskInstanceDependencyCollection`
        """
        model = TaskInstanceDependencyCollection()
        if include_optional:
            return TaskInstanceDependencyCollection(
                dependencies = [
                    airflow_client.models.task_failed_dependency.TaskFailedDependency(
                        name = '', 
                        reason = '', )
                    ]
            )
