...
**url** | **str** | The URL path where the server can be accessed (typically /user/:name/:server.name/). Will be a full URL if subdomains are configured.  | [optional] 
**progress_url** | **str** | The URL path for an event-stream to retrieve events during a spawn.  | [optional] 
**full_url** | **str** | The full URL of the server (&#x60;https://hub.example.org/user/:name/:servername&#x60;). &#x60;null&#x60; unless JupyterHub.public_url or subdomains are configured.  Added in 5.0.  | [optional] 
**full_progress_url** | **str** | The full URL for the progress events (&#x60;https://hub.example.org/hub/api/users/:name/servers/:servername/progress&#x60;). &#x60;null&#x60; unless JupyterHub.public_url is configured.  Added in 5.0.  | [optional] 
