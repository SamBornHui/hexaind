...
class PluginCollectionItem(BaseModel):
    ...
    macros: Optional[List[Optional[StrictStr]]] = Field(default=None, description="The plugin macros")
    flask_blueprints: Optional[List[Optional[StrictStr]]] = Field(default=None, description="The flask blueprints")
    ...
    global_operator_extra_links: Optional[List[Optional[StrictStr]]] = Field(default=None, description="The global operator extra links")
    operator_extra_links: Optional[List[Optional[StrictStr]]] = Field(default=None, description="Operator extra links")
    source: Optional[StrictStr] = Field(default=None, description="The plugin source")
    ti_deps: Optional[List[StrictStr]] = Field(default=None, description="The plugin task instance dependencies")
    listeners: Optional[List[StrictStr]] = Field(default=None, description="The plugin listeners")
    timetables: Optional[List[StrictStr]] = Field(default=None, description="The plugin timetables")
    __properties: ClassVar[List[str]] = ["name", "hooks", "executors", "macros", "flask_blueprints", "appbuilder_views", "appbuilder_menu_items", "global_operator_extra_links", "operator_extra_links", "source", "ti_deps", "listeners", "timetables"]
