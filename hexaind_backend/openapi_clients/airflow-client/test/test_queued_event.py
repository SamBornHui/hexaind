...
class TestQueuedEvent(unittest.TestCase):
    """QueuedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueuedEvent:
        """Test QueuedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueuedEvent`
        """
        model = QueuedEvent()
        if include_optional:
            return QueuedEvent(
