...
import { WidgetClientTags, WidgetClientType } from 'src/app/pages/workflow-designer/client-tags';

@Component({
  selector: 'app-excel-widget-config',
  templateUrl: './excel-widget-config.component.html',
  styleUrls: ['./excel-widget-config.component.less']
})
export class ExcelWidgetConfigComponent {
  ...
  initializeInformation() {
    this.data = {
      ...
      description: 'retrieves excel data for further processing upstream',
  ...
  onSave() {
    ...
    if (this.configCache && this.configCache.sink) {
      this.configCache.sink.dataset_name = 'excel_dataset';
      this.configCache.sink.dataset_description = 'excel_dataset_description';
