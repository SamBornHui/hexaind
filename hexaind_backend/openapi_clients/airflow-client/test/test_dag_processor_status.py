...
class TestDagProcessorStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DagProcessorStatus:
        """Test DagProcessorStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DagProcessorStatus`
        """
        model = DagProcessorStatus()
        if include_optional:
            return DagProcessorStatus(
                status = 'healthy',
