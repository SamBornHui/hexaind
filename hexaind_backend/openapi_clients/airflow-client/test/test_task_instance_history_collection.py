...
class TestTaskInstanceHistoryCollection(unittest.TestCase):
    """TaskInstanceHistoryCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskInstanceHistoryCollection:
        """Test TaskInstanceHistoryCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskInstanceHistoryCollection`
        """
        model = TaskInstanceHistoryCollection()
        if include_optional:
            return TaskInstanceHistoryCollection(
                total_entries = 56,
                task_instances_history = ERROR_TO_EXAMPLE_VALUE
            )
        else:
            return TaskInstanceHistoryCollection(
        )
    ...
    def testTaskInstanceHistoryCollection(self):
        """Test TaskInstanceHistoryCollection"""
