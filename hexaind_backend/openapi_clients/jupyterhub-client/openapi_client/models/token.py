...
class Token(BaseModel):
    ...
    scopes: Optional[List[StrictStr]] = Field(default=None, description="List of scopes this token has been assigned. New in JupyterHub 3. In JupyterHub 2.x, tokens were assigned 'roles' instead of scopes.")
    ...
    __properties: ClassVar[List[str]] = ["id", "user", "service", "roles", "scopes", "note", "created", "expires_at", "last_activity", "session_id"]
