    ...
    def make_instance(self, include_optional) -> DatasetCollection:
        ...
        if include_optional:
            return DatasetCollection(
                total_entries = 56,
                datasets = [
                    airflow_client.models.dataset.Dataset(
                        id = 56, 
                        uri = '', 
                        extra = airflow_client.models.extra.extra(), 
                        created_at = '', 
                        updated_at = '', 
                        consuming_dags = [
                            airflow_client.models.dag_schedule_dataset_reference.DagScheduleDatasetReference(
                                dag_id = '', 
                                created_at = '', 
                                updated_at = '', )
                            ], 
                        producing_tasks = [
                            airflow_client.models.task_outlet_dataset_reference.TaskOutletDatasetReference(
                                dag_id = '', 
                                task_id = '', 
                                created_at = '', 
                                updated_at = '', )
