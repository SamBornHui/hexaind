...
class TestDagStatsStateCollectionItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DagStatsStateCollectionItem:
        """Test DagStatsStateCollectionItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DagStatsStateCollectionItem`
        """
        model = DagStatsStateCollectionItem()
        if include_optional:
            return DagStatsStateCollectionItem(
                state = '',
                count = 56
            )
        else:
