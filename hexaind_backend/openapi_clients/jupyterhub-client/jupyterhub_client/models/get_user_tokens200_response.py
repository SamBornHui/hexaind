...
class GetUserTokens200Response(BaseModel):
    """
    GetUserTokens200Response
    """ # noqa: E501
    api_tokens: Optional[List[Token]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api_tokens": [Token.from_dict(_item) for _item in obj["api_tokens"]] if obj.get("api_tokens") is not None else None
        })
        return _obj
