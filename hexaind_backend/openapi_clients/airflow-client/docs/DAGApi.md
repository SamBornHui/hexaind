...
with airflow_client.ApiClient(configuration) as api_client:
    ...
    api_instance = airflow_client.DAGApi(api_client)
    dag_id = 'dag_id_example' # str | The DAG ID.
    clear_task_instances = airflow_client.ClearTaskInstances() # ClearTaskInstances | Parameters of action
...
with airflow_client.ApiClient(configuration) as api_client:
    ...
    api_instance = airflow_client.DAGApi(api_client)
    dag_id = 'dag_id_example' # str | The DAG ID.
    update_task_instances_state = airflow_client.UpdateTaskInstancesState() # UpdateTaskInstancesState | Parameters of action
